% Copyright (c) 2025, Qinghua Zhang, Beijing Normal University
% All rights reserved.
% This software is provided under the MIT License.
% See the LICENSE file for more details.
%
% Date: January 2025
% Email qhzhang@mail.bnu.edu.cn if you have any issues using this code
...
tic;  % 开始计时
ximage = AMD_solution(mask, y, psf, jit, samp, tautv, eta, miniter, maxiter);
elapsedTime = toc;  % 结束计时并获取经过的时间
fprintf('The function AMD_solution took %.4f seconds to run.\n', elapsedTime);  % 输出所用时间
